...
{
    [self invalidateTimer];
    self.imageCount = [self.delegate numberOfItemForCycleScrollView:self];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (([self.delegate respondsToSelector:@selector(customCollectionViewCellClassForCycleScrollView:)] || [self.delegate respondsToSelector:@selector(customCollectionViewCellNibForCycleScrollView:)]) && [self.delegate respondsToSelector:@selector(cycleScrollView:prepareCustomCell:forItemAtIndex:)]) {
        [self.delegate cycleScrollView:self prepareCustomCell:cell forItemAtIndex:itemIndex];
        return cell;
    }
    
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:prepareImageView:forItemAtIndex:)]) {
        [self.delegate cycleScrollView:self prepareImageView:cell.imageView forItemAtIndex:itemIndex];
    }
    
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:prepareLabel:forItemAtIndex:)]) {
        [self.delegate cycleScrollView:self prepareLabel:cell.titleLabel forItemAtIndex:itemIndex];
    }
